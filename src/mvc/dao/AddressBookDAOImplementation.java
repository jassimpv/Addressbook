    ...
    {   
       try
       {
          conn = DBConnection.getInstance().getConnect();
           ...
           String qry;
           qry = "insert into AddressBook values ('"+person.getName()+"','"+person.getMob()+"','"+person.getEmail()+"','"+person.getDepartment()+"','"+person.getMentor()+"')";
    ...
    @Override
     public void updatePerson(Person person,String name)
     {
         try
       {
           ...
           String qry="update AddressBook set name='"+person.getName()+"',mob='"+person.getMob()+"',email='"+person.getEmail()+"',department='"+person.getDepartment()+"',mentor='"+person.getMentor()+"',where name='"+name+"'";
           st.executeUpdate(qry);
           conn.close();
        }
    ...
    public void getSelectedName(DetailViewPanel detailPanel,String selectedName)
    {
        try {
            ...
            while(rs.next()){
             ...
             detailPanel.setDepartment(rs.getString("department"));
             detailPanel.setMentor(rs.getString("mentor"));
