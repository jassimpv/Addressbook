...
public class AddressBookController {
    ...
    private void openAdd(){   
       view.getMainGUIFrame().setVisible(false);
        ...
        choiceListener = new ActionListener() {
            ...
            String mentor=contactDetailsPanel.getMentorField().getText();
            flag = validate();
            if(flag)
            {    
             Person person = new Person();
             person.setData(name,mobile,email,department,mentor);
   ...
   */
    ...
    private void openEdit(){
        ...
        dialog.getPanel().setMentor(detailPanel.getMentorField().getText());
        view.getMainGUIFrame().setVisible(false);
        choiceListener = new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
...
daoimplement.getSearchNames(nlp,str);
    ...
    public void loadPersons()       
    {
        ...
        nlp.getJList().addListSelectionListener(new ListSelectionListener()
         ...
         detailPanel.getMentorField().setEditable(false);
        }
    }  //loadPersons ends
